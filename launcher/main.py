...
def install_forge():
    ...
    if not os.path.exists("launcher/minecraft/libraries/net/minecraft/launchwrapper/1.12"):
        os.makedirs("launcher/minecraft/libraries/net/minecraft/launchwrapper/1.12")
        wget.download(launch_wrapper, "launcher/minecraft/libraries/net/minecraft/launchwrapper/1.12")
        return True
    return True
